...
/datum/job/hop
	alt_titles = list("Crew Resource Officer", "Executive Officer", "Personnel Manager", "Staff Administrator", "Records Administrator")
...
/datum/job/curator
	alt_titles = list("Journalist", "Librarian", "Keeper", "Artist")

/datum/job/hydro
	alt_titles = list("Gardener", "Herbalist", "Botanical Researcher", "Florist", "Hydroponicist", "Farmer", "Beekeeper", "Vintner", "Soiler")
...
/datum/job/virologist
	alt_titles = list("Pathologist", "Microbiologist", "Biochemist")
